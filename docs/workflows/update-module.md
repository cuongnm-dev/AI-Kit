...
- Skill source: `~/.config/engine/skills/update-module/SKILL.md`
- Shared notepad: `~/.config/engine/skills/_shared/update-flow.md`
- Memory: feature-catalog.json `consumed_by_modules` (S-003)
